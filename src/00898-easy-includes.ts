 ...
 * 1. 
 */
// type Includes<T extends readonly any[], U> = T extends readonly (infer K)[]
//     ? U extends K ? true : false
//     : never

/**
 * 2. IsEqual<X, Y>
 * https://stackoverflow.com/questions/68961864/how-does-the-equals-work-in-typescript%EF%BC%89%E3%80%82
